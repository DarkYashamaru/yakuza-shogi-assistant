...
static_templates_folder = "templates/processed/numbers"
template_names = []
static_templates = []

def compare_against_templates(cell_to_compare, templates)->int:
    highest_score = 0
    best_match = "empty"
...
def compare_number(img: np.array) -> int:
    ...
    number_result = compare_against_templates(normalized, static_templates)
